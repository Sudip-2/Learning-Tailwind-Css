...
app.post("/submit", (req, res) => {
  ...
  res.render("index.ejs",{bandName:generateName(adj,noun)})
});
...
function generateName(arr1,arr2){
  const name1 = arr1[Math.floor(Math.random()*1348)];
  const name2 = arr2[Math.floor(Math.random()*4310)];
  return `${name1} ${name2}`
}